...
class RoboController:
    ...
    def spawn_human(self):
        ...
        # 🔥 HUMAN DISAPPEARS AFTER 15 SECONDS
    ...
    def remove_human(self):
        for part in self.human_parts:
            self.canvas.delete(part)
        self.human_parts.clear()
        self.log_event("Human Cleared After 15 Seconds")

        # Resume movement automatically
    ...
    def animate_step(self):
        ...
        self.travelled = (pixels_travelled / self.total_road_pixels) * self.total_distance

        self.update_ui()

        self.after_id = self.root.after(self.move_delay, self.animate_step)
